...
function formatCSSVariables(h: number, s: number) {
  ...
  return {
    ...
    "--color-primary-300": formatHex({ mode, h, s, l: 0.7 }),
    "--color-primary-400": formatHex({ mode, h, s, l: 0.6 }),
    "--color-primary-500": formatHex({ mode, h, s, l: 0.5 }),
    "--color-primary-600": formatHex({ mode, h, s, l: 0.4 }),
    "--color-primary-700": formatHex({ mode, h, s, l: 0.3 }),
    "--color-primary-800": formatHex({ mode, h, s, l: 0.2 }),
